...
<div class="content-header content-header-media">
    ...
    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/headers/dashboard_header.jpg" alt="header image" class="animation-pulseSlow">
</div>
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                            <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo1.jpg" alt="image">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a href="img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                            <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo22.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                            <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo23.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="widget">
            <div class="widget-advanced widget-advanced-alt">
                ...
                <div class="widget-header text-left">
                    ...
                    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-3">
                                <a href="img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo15.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo5.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo6.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
                                    <img src="<?php echo $prouiAsset->baseUrl; ?>/img/placeholders/photos/photo13.jpg" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
