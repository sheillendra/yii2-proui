...
-->
<header class="navbar navbar-inverse navbar-fixed-top header-fixed-top">
    ...
    <ul class="nav navbar-nav-custom pull-right">
        ...
        <li class="dropdown">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo $prouiAsset->baseUrl ?>/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
            </a>
